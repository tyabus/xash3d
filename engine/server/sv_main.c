...
void SV_Init( void )
{
	...
	sv_timeout = Cvar_Get( "sv_timeout", "65", CVAR_SERVERNOTIFY, "connection timeout" );
	...
	sv_reconnect_limit = Cvar_Get ("sv_reconnect_limit", "2.5", CVAR_ARCHIVE, "max reconnect attempts" );
