...
// helper functions
static inline int BF_GetNumBytesWritten( sizebuf_t *bf ) { return BitByte( bf->iCurBit ); }
static inline int BF_GetRealBytesWritten( sizebuf_t *bf ) { return bf->iCurBit >> 3; }	// unpadded
static inline int BF_GetNumBitsWritten( sizebuf_t *bf ) { return bf->iCurBit; }
static inline int BF_GetMaxBits( sizebuf_t *bf ) { return bf->nDataBits; }
static inline int BF_GetMaxBytes( sizebuf_t *bf ) { return bf->nDataBits >> 3; }
static inline int BF_GetNumBitsLeft( sizebuf_t *bf ) { return bf->nDataBits - bf->iCurBit; }
static inline int BF_GetNumBytesLeft( sizebuf_t *bf ) { return BF_GetNumBitsLeft( bf ) >> 3; }
static inline byte *BF_GetData( sizebuf_t *bf ) { return bf->pData; }
